...
export function HeroSection() {
  return (
    <section
      id="product"
      className="relative min-h-screen overflow-hidden bg-birzont-charcoal pt-28 pb-16 md:pt-36 md:pb-20"
    >
        ...
        <div className="mx-auto max-w-3xl text-center">
          <FadeIn>
            <motion.div
              ...
              className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.05] px-4 py-1.5 text-xs font-medium text-white/60 backdrop-blur-sm"
            >
              <span className="h-1.5 w-1.5 rounded-full bg-birzont-green" />
              팀 지식을 모든 AI 에이전트 안으로
            </motion.div>
          </FadeIn>

          <FadeIn delay={0.05}>
            <h1 className="text-balance text-4xl font-bold leading-[1.1] tracking-tight md:text-5xl lg:text-[3.25rem]">
              AI에게 매번 설명하는
              <br />
