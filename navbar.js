  ...
  const NAVBAR_TEMPLATE = `
      ...
      <div class="w-full md:w-[calc(95%-110px)] md:max-w-[1506px] flex justify-between items-center">
        ...
        <nav id="desktop-nav" class="flex gap-4 justify-end flex-1 mr-6">
          ...
          <div class="relative nav-item" data-item="Blog">
            <a href="index.html#blog" class="font-normal text-[1rem] transition-colors px-3 py-1.5 rounded-lg hover:bg-gray-100/70 text-white">Blog</a>
          </div>
          ...
          <div class="relative nav-item">
            <a href="index.html#pricing" class="font-normal text-[1rem] transition-colors px-3 py-1.5 rounded-lg hover:bg-gray-100/70 text-white">Pricing</a>
          </div>
        </nav>
    ...
    <div id="mobile-menu" class="fixed top-[48px] left-0 w-full bg-white text-black z-40 shadow-lg transform transition-all duration-300 ease-in-out -translate-y-full opacity-0">
      <div class="py-4 px-6">
        ...
        <a href="index.html#blog" class="block py-3 px-4 text-lg font-medium border-b border-gray-100 hover:bg-gray-50">Blog</a>
        <a href="index.html#career" class="block py-3 px-4 text-lg font-medium border-b border-gray-100 hover:bg-gray-50">Career</a>
        <a href="index.html#pricing" class="block py-3 px-4 text-lg font-medium border-b border-gray-100 hover:bg-gray-50">Pricing</a>
        <div class="mt-4 pt-2">
